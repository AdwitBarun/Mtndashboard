...
const sub10001 = `    id: "SUB-10001",
    ...
    householdMembers: [
      { id: "HM-1", name: "Rohan", initials: "RM", role: "Primary", device: "Galaxy S24", os: "", usageShare: 39, color: "#4F46E5", data: "31 GB" },
      { id: "HM-2", name: "Priya", initials: "PM", role: "Secondary", device: "iPhone 15", os: "", usageShare: 35, color: "#7C3AED", data: "28 GB" },
      { id: "HM-3", name: "Arjun", initials: "AM", role: "Secondary", device: "Galaxy A54", os: "", usageShare: 25, color: "#8B5CF6", data: "20 GB" }
    ],
    behavioralTags: [
...
const regex = /    id: "SUB-10001",[\s\S]*?journeyActivity: \([\s\S]*?\]/m
const regex2 = /    id: "SUB-10001",[\s\S]*?\]\n  \},/m

content = content.replace(regex2, sub10001 + "\n  },")
